...
import com.ihris.unsplashapi.data.Repository
import com.ihris.unsplashapi.data.models.PhotoResponse
import com.ihris.unsplashapi.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onRequestPermissionsResult(
        ...
        val writeExternalStoragePermissionGranted = requestCode == REQUEST_WRITE_EXTERNAL_STORAGE_PERMISSION && grantResults[0] == PackageManager.PERMISSION_GRANTED
